...
variable "name" {
  description = "Name for resources, defaults to \"nomad-aws\"."
  default     = "nomad-aws"
}
...
variable "count" {
  description = "Number of Nomad nodes to provision across private subnets, defaults to private subnet count."
  default     = -1
}

variable "instance_type" {
  description = "AWS instance type for Nomad node (e.g. \"m4.large\"), defaults to \"t2.small\"."
  default     = "t2.small"
}
